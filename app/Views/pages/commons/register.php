                                ...
                                <div class="card-body">
                                    ...
                                    <div class="m-sm-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="email" name="username" placeholder="Enter your email" required />
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control form-control-lg" type="password" name="password_confirm" placeholder="Repeat your password" required />
                                            <small>
